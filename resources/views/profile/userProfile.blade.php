                ...
                <div class="col-md-8 col-sm-6 col-xs-12 personal-info">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="updateInfo">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input class="form-control" value="{{ \Illuminate\Support\Facades\Auth::user()->name }}" type="text" name="mem_name"
                                       required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input class="form-control" value="{{ \Illuminate\Support\Facades\Auth::user()->email }}" type="text" name="emailid"
                                       required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input class="form-control" value="{{ \Illuminate\Support\Facades\Auth::user()->address }}" type="text" name="address"
                                       required>
                            </div>
                        </div>
